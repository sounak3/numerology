...
# Define a constant for the repeated description
NOT_A_COMPOUND_NUMBER_DESC = _("Not a compound number")

# Define a constant for the repeated fortunate number description
TWO_NUMBER_DESC = _("This number indicates uncertainties, treachery, and deception of others. It foreshadows trials, tribulations, and unexpected dangers, along with unreliable friends and grief caused by members of the opposite sex.")

# Define a constant for the repeated fortunate number description
THREE_NUMBER_DESC = _("A number of thoughtful deduction and retrospection, it represents mental superiority over one’s fellows. It can be all-powerful, but it is just as often indifferent according to the will or desire of the person.")

# Define a constant for the repeated fortunate number description
FOUR_NUMBER_DESC = _("A number of thoughtful deduction, retrospection and mental superiority. This number represents a person who is even more self-contained, lonely, and isolated from his fellows. It is not a fortunate number from a worldly or material standpoint.")

# Define a constant for the repeated fortunate number description
FIVE_NUMBER_DESC = _("This number has a magical power like the single 5 or the \"compound\" numbers 14 and 23. It is usually associated with combinations of people or nations. It is a favorable number if the person it represents holds to his own judgment and opinions.")

# Define a constant for the repeated fortunate number description
SIX_NUMBER_DESC = _("Another fortunate number, it promises assistance and association with those of rank and position in one’s plans. It also denotes gain through love and the opposite sex.")

# Define a constant for the repeated fortunate number description
SEVEN_NUMBER_DESC = _("This number denotes strength gained through experience and benefits obtained through the observation of people and things. While not deemed exactly \"lucky,\" it is favorable when it appears in relation to the future.")

# Define a constant for the repeated fortunate number description
EIGHT_NUMBER_DESC = _("Full of grave warnings for the future, this number foreshadows disasters brought about by association with others, ruin through bad speculations, partnerships, unions, and bad advice.")

# Define a constant for the repeated fortunate number description
NINE_NUMBER_DESC = _("Symbolized as \"the Sceptre,\" this number promises authority, power, and command. It indicates that rewards will come from the productive intellect and that the creative faculties have sown good seeds that will reap a harvest.")
...
class CompoundNumber:
    ...
    meanings: Dict[int, Dict[str, str]] = {
        1: {
            ...
            "description": NOT_A_COMPOUND_NUMBER_DESC,
        },
        2: {
        ...
        24: {
            ...
            "description": SIX_NUMBER_DESC,
        },
        25: {
            "title": _("Compound number 25"),
            "description": SEVEN_NUMBER_DESC,
        },
        26: {
            "title": _("Compound number 26"),
            "description": EIGHT_NUMBER_DESC,
        },
        27: {
            "title": _("Compound number 27"),
            "description": NINE_NUMBER_DESC,
        },
        28: {
        ...
        29: {
            ...
            "description": TWO_NUMBER_DESC,
        },
        30: {
            "title": _("Compound number 30"),
            "description": THREE_NUMBER_DESC,
        },
        31: {
            "title": _("Compound number 31"),
            "description": FOUR_NUMBER_DESC,
        },
        32: {
            "title": _("Compound number 32"),
            "description": FIVE_NUMBER_DESC,
        },
        33: {
